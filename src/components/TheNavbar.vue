    ...
    <div class="container-width">
      <div class="relative flex h-24 items-center justify-between">
        <div class="flex items-center">
          <a href="#" class="text-4xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
            Synergize
          </a>
        </div>
        ...
        <!-- Mobile menu button -->
        <div class="md:hidden">
          <DisclosureButton class="text-gray-300">
    ...
    <DisclosurePanel class="md:hidden">
      <div class="space-y-1 px-4 pb-3 pt-2">
        <button
          ...
          :key="index"
          @click="scrollToSection(section)"
          class="block w-full text-left text-gray-300 hover:text-primary py-2"
        >
          {{ section.charAt(0).toUpperCase() + section.slice(1) }}
        </button>
      </div>
